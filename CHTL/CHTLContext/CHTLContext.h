...
public:
    ...
    std::map<std::string, std::shared_ptr<CustomDefinitionNode>> customStyleTemplates;
    std::map<std::string, std::shared_ptr<CustomDefinitionNode>> customElementTemplates;
    std::map<std::string, std::shared_ptr<CustomDefinitionNode>> customVarTemplates;
