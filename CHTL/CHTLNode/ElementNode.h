...
public:
    ...
    void addConditional(std::unique_ptr<ConditionalNode> conditionalNode);
    ...
    const std::vector<std::unique_ptr<ConditionalNode>>& getConditionals() const;
...
private:
    ...
    std::vector<std::unique_ptr<ConditionalNode>> conditionals;
};
